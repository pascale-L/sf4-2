...
class AccountController extends AbstractController
{
    ...
    /**
     * abstractions (classes abstraites, interfaces) implémentations (classes qui *implémentent les interfaces, etc)
     * 
     * 
     * @Route("/account/profile", name="account_profile")
     * Autoriser l'accés uniquement aux utilisateurs connectés
     * @IsGranted("ROLE_USER")
     */
